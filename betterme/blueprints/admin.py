...
from flask import render_template, flash, request, current_app, Blueprint
from flask_login import login_required

from betterme.decorators import admin_required, permission_required
from betterme.extensions import db
from betterme.forms.admin import EditProfileAdminForm
from betterme.models import Role, User, Post, Tag, Comment
from betterme.utils import redirect_back
...
@admin_bp.route('/manage/post', defaults={'order': 'by_flag'})
@admin_bp.route('/manage/post/<order>')
@login_required
@permission_required('MODERATE')
